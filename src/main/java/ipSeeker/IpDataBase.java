...
public class IpDataBase {
	...
	private IpDataBase() {
		//System.out.println(IpDataBase.class.getClassLoader().getResource("qqwry.dat"));
		//System.out.println(IpDataBase.class.getResource("/").getPath().toString());
        TMP_FILE = this.getClass().getResource("/").getPath().toString() + TMP_FILE;
		//TMP_FILE = IpDataBase.class.getClassLoader().getResource("ip.tmp").toString();
	}
